    ...
    <div class="drm-row">
        ...
        <ul class="cpt-info">
            ...
            <?php if ( $publisher ) : ?>
                <li>
                    <i class="fa fa-user"></i> 
                    <span class="drm-bold">Publisher:</span> 
            ...
            <?php if ( $length ) : ?>
                <li>
                    <i class="fa fa-user"></i> 
                    <span class="drm-bold">Length:</span> 
            ...
            <?php if ( $published_year ) : ?>
                <li>
                    <i class="fa fa-user"></i> 
                    <span class="drm-bold">Year Published:</span> 
            ...
            <?php if ( $language ) : ?>
                <li>
                    <i class="fa fa-user"></i> 
                    <span class="drm-bold">Language:</span> 
