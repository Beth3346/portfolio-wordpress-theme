...
<main class="main-content">
    ...
    <!-- if video archive or video custom taxonomy show grid -->
        ...
        <div class="cpt-grid">
            <div class="cpt-grid-nav">
                ...
                <nav class="num-results-nav">
                    <ul>
                        <li><a class="active" href="/videos/" data-num="20">20</a></li>
                        <li><a href="/videos/" data-num="40">40</a></li>
                        <li><a href="/videos/" data-num="-1">All</a></li>
                    </ul>
                </nav>

                <h3>Filter Results:</h3>

                <?php elr_tax_nav( 'videos', 'video_type', $tax_term ); ?>
            </div>
            <div class="cpt-grid-content" data-post-type="video">
                <?php elr_get_loop(); ?>
