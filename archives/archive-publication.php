...
<main class="main-content">
    ...
    <!-- if publication archive or publication custom taxonomy show grid -->
        ...
        <div class="cpt-grid">
            <div class="cpt-grid-nav">
                ...
                <nav class="num-results-nav">
                    <ul>
                        <li><a class="active" href="/publications/" data-num="20">20</a></li>
                        <li><a href="/publications/" data-num="40">40</a></li>
                        <li><a href="/publications/" data-num="-1">All</a></li>
                    </ul>
                </nav>
